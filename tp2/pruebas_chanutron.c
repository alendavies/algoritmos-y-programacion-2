...
void pruebas_crear_sala()
{
	...
	pa2m_afirmar(sala_crear_desde_archivos("arch_pruebas/obj.dat",
					       "arch_pruebas/vacio.txt") == NULL,
		     "No puedo crear la sala sin interacciones");

	sala_t *sala =
		sala_crear_desde_archivos("arch_pruebas/obj.dat", "arch_pruebas/int.csv");
...
void pruebas_escenario_basico()
{
	...
	pa2m_afirmar((sala = sala_crear_desde_archivos(
			      "arch_pruebas/obj_basico.txt",
			      "arch_pruebas/int_basico.txt")) != NULL,
